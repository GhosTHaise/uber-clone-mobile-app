...
const CustomButton = ({
    ...
    ...props }: ButtonProps) => (
    <TouchableOpacity
        className={`w-full p-3 mb-4 rounded-full flex felx-row justify-center items-center shadow-md shadow-neutral-400/70 ${getBgVariantStyle(bgVariant)} ${className}`}
        onPress={onPress}
        {...props}
    >
        {IconLeft && (<IconLeft />)}
